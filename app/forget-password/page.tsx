...
export default function ForgotPasswordPage() {
  ...
  // simple inline styles so you don't need Tailwind here
  const styles = {
    page: {
      minHeight: "100vh",
      background: "#7bd0ff", // sky-300 feel
    },
    ...
    card: {
      ...
      width: "100%",
      maxWidth: 900,
      background: "rgba(56, 189, 248, 0.7)", // sky-400/70
      borderRadius: 28,
    ...
    resendBtn: {
      ...
      color: "#fff",
      background:
        "linear-gradient(to bottom, rgb(67, 56, 202), rgb(79, 70, 229))", // indigo-ish
    ...
    submitBtn: {
      ...
      color: "#fff",
      background:
        "linear-gradient(to bottom, rgb(67, 56, 202), rgb(79, 70, 229))",
    ...
    backWrap: { padding: 24 },
    note: { textAlign: "center" as const, marginTop: 8, color: "#065f46" }, // emerald-700
    error: { textAlign: "center" as const, marginTop: 8, color: "#b91c1c" }, // red-700
  };
  ...
  async function sendOrResendOtp() {
    ...
    try {
      ...
      setOtpSent(true);
      if (typeof d.cooldown === "number") setCooldown(d.cooldown); // server enforces (60s)
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.backWrap}>
        <Link href="/" aria-label="Back to login" style={styles.back}>
          ←
        </Link>
      </div>
      ...
      <div style={styles.container as React.CSSProperties}>
        ...
        <div style={styles.card}>
          ...
          <div style={styles.formWrap}>
            ...
            {/* New password fields appear after OTP is sent */}
            {otpSent && (
              <>
