    ...
    <div className="amv-root">
      ...
      <div className="gridwrap">
        ...
        <div className="cal-wrap">
          {/* >>> Back arrow: big, no underline, next to calendar */}
        ...
        <div className="book-card">
          ...
          <form onSubmit={onSave} className="book-form">
            ...
            {/* TIME (left-aligned, no underline) */}
            <div className="row">
...
/* ---------- Calendar ---------- */
.cal-wrap{position:relative;padding-left:80px;} /* keep a margin for the back arrow */
.outside-back{
  position:absolute;
  left:16px;                 /* sits right next to the calendar card */
  top:50%;
  transform:translateY(-50%);
  font-size:56px;            /* a bit big */
  line-height:1;
...
.outside-back:visited{color:#000;text-decoration:none}
.outside-back:hover{transform:translateY(-50%) scale(0.98);} /* subtle tap feel */
