...
/* ---------- Calendar ---------- */
.cal-wrap{position:relative;padding-left:80px;} /* keep space for the back arrow */
.outside-back{
  position:absolute;
  left:16px;                 /* sits beside the white calendar card */
  top:50%;
  transform:translateY(-50%);
  display:block;
  line-height:1;
  font-size:56px;            /* bigger arrow */
...
.outside-back:hover{transform:translateY(-50%) scale(0.98);} /* tiny feedback */
